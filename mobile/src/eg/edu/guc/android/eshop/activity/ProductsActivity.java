	...
	private void setUpViews() {
		...
		adpProducts = new ArrayAdapter<Product>(this, 0) {
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				View view;
				if (convertView == null) {
					view = mInflater.inflate(R.layout.view_product, parent,
							false);
				} else {
					view = convertView;
				}
				...
				Picasso.with(ProductsActivity.this).load(product.getImageUrl())
						.into(imgImage);
				...
				btnBuy.setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View v) {
						...
						ApiRouter.withToken(getCurrentUser().getToken())
								.patchProductBuy(product.getId(),
